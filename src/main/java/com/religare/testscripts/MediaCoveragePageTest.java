...
public class MediaCoveragePageTest {
	...
	public void launchDisclosurePage() {
		...
		driver.get("https://rhicluat.religarehealthinsurance.com/religare-health-insurance-in-media.html");
	...
	public void mediaCoverageTestPdf() throws Throwable {
		...
		List<WebElement> listOfPdf = driver.findElements(By.xpath("//a[@class='ng-binding']"));
		...
		FileOutputStream fileOut = new FileOutputStream("D://Media_" + System.currentTimeMillis() + ".xlsx");
