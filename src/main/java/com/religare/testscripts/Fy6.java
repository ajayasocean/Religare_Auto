...
public class Fy6 {
	...
	public void disclosurePageQtr1_12_13Test() throws Throwable {
		JavascriptExecutor jse = (JavascriptExecutor) driver;
		jse.executeScript("javascript:window.scrollBy(0,250)");
		// Getting the size of frame
		Thread.sleep(1500);
		driver.switchTo().frame(index);
		driver.findElement(By.xpath("//div[@headerindex ='5h']")).click();
		Workbook workbook = new XSSFWorkbook();

		CreationHelper createHelper = workbook.getCreationHelper();

		Sheet sheet = workbook.createSheet("Qtr1_12_13");
		...
		WebElement container = driver.findElement(By.xpath("//a[contains(text(), 'Qtr 1 12-13')]"));
		...
		for (i = 0; i < web.size(); i++) {
			...
			File destFile = new File(".\\Qtr1-12-13Screenshot\\" + pngName + ".png");
		...
		FileOutputStream fileOut = new FileOutputStream(".\\12_13ExcelSheets\\" + System.currentTimeMillis() + ".xlsx");
	...
	public void disclosurePageQtr2_12_13Test() throws Throwable {
		...
		Sheet sheet = workbook.createSheet("Qtr2_12_13");
		...
		WebElement container = driver.findElement(By.xpath("//a[contains(text(), 'Qtr 2 12-13')]"));
		...
		for (i = 0; i < web.size(); i++) {
			...
			File destFile = new File(".\\Qtr2-12-12Screenshot\\" + pngName + ".png");
	...
	public void disclosurePageQtr3_12_13Test() throws Throwable {
		JavascriptExecutor jse = (JavascriptExecutor) driver;
		jse.executeScript("javascript:window.scrollBy(0,250)");
		// Getting the size of frame
		Thread.sleep(1500);
		...
		Sheet sheet = workbook.createSheet("Qtr3_12_13");
		...
		WebElement container = driver.findElement(By.xpath("//a[contains(text(), 'Qtr 3 12-13')]"));
		...
		for (i = 0; i < web.size(); i++) {
			...
			File destFile = new File(".\\Qtr3-12-13Screenshot\\" + pngName + ".png");
	...
	public void disclosurePageQtr4_12_13Test() throws Throwable {
		JavascriptExecutor jse = (JavascriptExecutor) driver;
		jse.executeScript("javascript:window.scrollBy(0,250)");
		// jse.executeScript("arguments[0].scroll, arg1)
		// Getting the size of frame
		Thread.sleep(1500);
		try {
			driver.switchTo().frame(index);
		...
		Sheet sheet = workbook.createSheet("Qtr4_12_13");
		...
		WebElement container = driver.findElement(By.xpath("//a[contains(text(), 'Qtr 4 12-13')]"));
		...
		for (i = 0; i < web.size(); i++) {
			...
			File destFile = new File(".\\Qtr4-12-13Screenshot\\" + pngName + ".png");
