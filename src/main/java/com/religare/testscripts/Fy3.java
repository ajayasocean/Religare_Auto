...
public class Fy3 {
	...
	public void disclosurePageQtr1_15_16Test() throws Throwable {

		// Getting the size of frame
		Thread.sleep(1500);
		driver.switchTo().frame(index);
		driver.findElement(By.xpath("//code[contains(text(),'FY 15-16')]")).click();
		Workbook workbook = new XSSFWorkbook();

		CreationHelper createHelper = workbook.getCreationHelper();

		Sheet sheet = workbook.createSheet("Qtr1_15_16");
		...
		WebElement container = driver.findElement(By.xpath("//a[contains(text(), 'Qtr 1 15-16')]"));
		...
		for (i = 0; i < web.size(); i++) {
			...
			File destFile = new File(".\\Qtr1-15-16Screenshot\\" + pngName + ".png");
		...
		FileOutputStream fileOut = new FileOutputStream(".\\15_16ExcelSheets\\" + System.currentTimeMillis() + ".xlsx");
	...
	public void disclosurePageQtr2_15_16Test() throws Throwable {
		...
		Sheet sheet = workbook.createSheet("Qtr2_15_16");
		...
		WebElement container = driver.findElement(By.xpath("//a[contains(text(), 'Qtr 2 15-16')]"));
		...
		for (i = 0; i < web.size(); i++) {
			...
			File destFile = new File(".\\Qtr2-15-16Screenshot\\" + pngName + ".png");
	...
	public void disclosurePageQtr3_15_16Test() throws Throwable {
		...
		Sheet sheet = workbook.createSheet("Qtr3_15_16");
		...
		WebElement container = driver.findElement(By.xpath("//a[contains(text(), 'Qtr 3 15-16')]"));
		...
		for (i = 0; i < web.size(); i++) {
			...
			File destFile = new File(".\\Qtr3-15-16Screenshot\\" + pngName + ".png");
	...
	public void disclosurePageQtr4_15_16Test() throws Throwable {
...
//		jse.executeScript("window.scrollBy(0, 1000)", "");
		...
		Sheet sheet = workbook.createSheet("Qtr4_15_16");
		...
		WebElement container = driver.findElement(By.xpath("//a[contains(text(), 'Qtr 4 15-16')]"));
