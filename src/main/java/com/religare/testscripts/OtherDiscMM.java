...
public class OtherDiscMM {
	...
	public void otherDiscMMTest() throws IOException, Throwable {
	...
	//	jse.executeScript("window.scrollBy(0, 200)", "");
		...
		//// div[@class ='technology closedlanguage' and @headerindex='3h']

		// driver.findElement(By.xpath("//code[contains(text(), 'mmmmmm')]")).click();
		...
		//// div[@contentindex ='3c']/ul/li

		List<WebElement> pdfNames = driver.findElements(By.xpath("//div[@contentindex ='3c']/ul/li"));
		...
		for (int i = 0; i < pdfNames.size(); i++) {
			...
			List<WebElement> pdf = driver.findElements(By.xpath("//div[@contentindex ='3c']/ul/li/a"));
			...
			File destFile = new File(
					".\\ScreenshotOD4\\" + pdfName + System.currentTimeMillis() + "neotherdisclouserr.png");
		...
		FileOutputStream fileOut = new FileOutputStream(
				".\\OD_4_ExcelSheets\\" + System.currentTimeMillis() + "neotherdisclouserr.xlsx");
