...
public class OtherDiscMisc {
	...
	public void otherDiscMiscTest() throws IOException {
		...
		driver.findElement(By.xpath("//div[@headerindex ='6h']")).click();
		...
		List<WebElement> pdfNames = driver
				.findElements(By.xpath("//div[@contentindex ='6c']/ul/li"));
	...
	//	}
		...
		List<WebElement> pdf = driver.findElements(By.xpath("//div[@contentindex ='6c']/ul/li/a"));
	...
	//	for (int i = 0; i < pdf.size(); i++) {
			...
			driver.switchTo().window(childWin);
			 ...
			 File destFile = new File(".\\ScreenshotOD3\\"  + pdfName + System.currentTimeMillis() + "mmmmmm.png");
		...
		FileOutputStream fileOut = new FileOutputStream(".\\OD_3_ExcelSheets\\" + System.currentTimeMillis() + "mmmmmm.xlsx");
