...
public class Fy5 {
	...
	public void disclosurePageQtr1_13_14Test() throws Throwable {

		// Getting the size of frame
		Thread.sleep(1500);
		driver.switchTo().frame(index);
		driver.findElement(By.xpath("//code[contains(text(),'FY 13-14')]")).click();
		Workbook workbook = new XSSFWorkbook();

		CreationHelper createHelper = workbook.getCreationHelper();

		Sheet sheet = workbook.createSheet("Qtr1_13_14");
		...
		WebElement container = driver.findElement(By.xpath("//a[contains(text(), 'Qtr 1 13-14')]"));
		...
		for (i = 0; i < web.size(); i++) {
			...
			File destFile = new File(".\\Qtr1-13-14Screenshot\\" + pngName + ".png");
		...
		FileOutputStream fileOut = new FileOutputStream(".\\13_14ExcelSheets\\" + System.currentTimeMillis() + ".xlsx");
	...
	public void disclosurePageQtr2_13_14Test() throws Throwable {
		...
		Sheet sheet = workbook.createSheet("Qtr2_13_14");
		...
		WebElement container = driver.findElement(By.xpath("//a[contains(text(), 'Qtr 2 13-14')]"));
		...
		for (i = 0; i < web.size(); i++) {
			...
			File destFile = new File(".\\Qtr2-13-14Screenshot\\" + pngName + ".png");
	...
	public void disclosurePageQtr3_13_14Test() throws Throwable {
		...
		Sheet sheet = workbook.createSheet("Qtr3_13_14");
		...
		WebElement container = driver.findElement(By.xpath("//a[contains(text(), 'Qtr 3 13-14')]"));
		...
		for (i = 0; i < web.size(); i++) {
			...
			File destFile = new File(".\\Qtr3-13-14Screenshot\\" + pngName + ".png");
	...
	public void disclosurePageQtr4_13_14Test() throws Throwable {
		...
		Sheet sheet = workbook.createSheet("Qtr4_13_14");
		...
		WebElement container = driver.findElement(By.xpath("//a[contains(text(), 'Qtr 4 13-14')]"));
		...
		for (i = 0; i < web.size(); i++) {
			...
			File destFile = new File(".\\Qtr4-13-14Screenshot\\" + pngName + ".png");
