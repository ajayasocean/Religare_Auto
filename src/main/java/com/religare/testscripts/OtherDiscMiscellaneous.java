...
public class OtherDiscMiscellaneous {
	...
	public void otherDiscMiscellaneousTest() throws Throwable {
		...
		//driver.findElement(By.xpath("//code[contains(text(), 'Miscellaneous')]")).click();
		
		driver.findElement(By.xpath("//div[@class ='technology closedlanguage' and @headerindex='2h']")).click();
		...
		//String pdfName;
		//
	//	"//div[@class='brochureOuter']/div/div[3]/div[2]/ul/li"

		List<WebElement> pdfNames = driver
				.findElements(By.xpath("//div[@contentindex ='2c']/ul/li"));
	...
	//
		...
		List<WebElement> pdf = driver.findElements(By.xpath("//div[@contentindex ='2c']/ul/li/a"));
	...
	//	for (int i = 0; i < pdf.size(); i++) {
			...
			driver.switchTo().window(childWin);
			 ...
			 File destFile = new File(".\\ScreenshotOD2\\"  + pdfName + System.currentTimeMillis() + "Miscellaneous.png");
		...
		FileOutputStream fileOut = new FileOutputStream(".\\OD_2_ExcelSheets\\" + System.currentTimeMillis() + "Miscellaneous.xlsx");
