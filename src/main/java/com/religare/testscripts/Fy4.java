...
public class Fy4 {
	...
	public void disclosurePageQtr1_14_15Test() throws Throwable {

		// Getting the size of frame
		Thread.sleep(1500);
		driver.switchTo().frame(index);
		driver.findElement(By.xpath("//div[@headerindex ='3h']")).click();
		Workbook workbook = new XSSFWorkbook();

		CreationHelper createHelper = workbook.getCreationHelper();

		Sheet sheet = workbook.createSheet("Qtr1_14_15");
		...
		WebElement container = driver.findElement(By.xpath("//a[contains(text(), 'Qtr 1 14-15')]"));
		...
		FileOutputStream fileOut = new FileOutputStream(".\\14_15ExcelSheets\\" + System.currentTimeMillis() + ".xlsx");
	...
	public void disclosurePageQtr2_14_15Test() throws Throwable {
...
//		jse1.executeScript("window.scrollBy(0, 1000)", "");
		...
		Sheet sheet = workbook.createSheet("Qtr2_14_15");
		...
		WebElement container = driver.findElement(By.xpath("//a[contains(text(), 'Qtr 2 14-15')]"));
		...
		for (i = 0; i < web.size(); i++) {
			...
			File destFile = new File(".\\Qtr2-14-15Screenshot\\" + pngName + ".png");
	...
	public void disclosurePageQtr3_14_15Test() throws Throwable {
		...
		Sheet sheet = workbook.createSheet("Qtr3_14_15");
		...
		WebElement container = driver.findElement(By.xpath("//a[contains(text(), 'Qtr 3 14-15')]"));
		...
		for (i = 0; i < web.size(); i++) {
			...
			File destFile = new File(".\\Qtr3-14-15Screenshot\\" + pngName + ".png");
	...
	public void disclosurePageQtr4_14_15Test() throws Throwable {
		...
		Sheet sheet = workbook.createSheet("Qtr4_14_15");
		...
		WebElement container = driver.findElement(By.xpath("//a[contains(text(), 'Qtr 4 14-15')]"));
		...
		for (i = 0; i < web.size(); i++) {
			...
			File destFile = new File(".\\Qtr4-14-15Screenshot\\" + pngName + ".png");
