...
public class OtherDiscWhistleTest {
	...
	public void otherDiscWhistleTest() throws IOException {
		...
		List<WebElement> pdfNames = driver
				.findElements(By.xpath("//div[@contentindex ='5c']/ul/li"));
	...
	//	}
		...
		List<WebElement> pdf = driver.findElements(By.xpath("//div[@contentindex ='5c']/ul/li/a"));
	...
	//	System.out.println(pdf.size());
		...
		//for (int i = 0; i < pdf.size(); i++) {
			...
			TakesScreenshot t = (TakesScreenshot) driver;
			 ...
			 File destFile = new File(".\\ScreenshotOD7\\"  + pdfName + System.currentTimeMillis() + "test.png");
		...
		FileOutputStream fileOut = new FileOutputStream(".\\OD_7_ExcelSheets\\" + System.currentTimeMillis() + "test.xlsx");
